...
enum Metrics {
    ...
    /// Taller body for the Obsidian tab: a quick-capture box over a search field and a
    /// scrolling list of vault notes (or a note preview). Kept below `moodExpandedHeight`
